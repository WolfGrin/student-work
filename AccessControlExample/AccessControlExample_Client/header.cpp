/*	Клиентская часть программы с реализацией
	поочередного доступа к ресурсам сервера
	для корректной работы проекта, необходимо подключить библиотеку ws2_32.lib
...
*/
  ...
  {
    char buff[10*1014];
    printf("DEMONSTRATION OF ACCESS STRUCTURES: Client\n\n");
